...
import type { TabsIcon } from "react-native-jelly-tabs";

// Small material-style glyphs drawn with react-native-svg so previews work on
// the web without loading an icon font.
const makeIcon =
    (d: string): TabsIcon =>
    function JellyIcon({ color, size }) {
        return (
...
export const HomeIcon = makeIcon("M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z");
...
export const PaintIcon = makeIcon(
    "M18 4V3c0-.55-.45-1-1-1H5c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1h12c.55 0 1-.45 1-1V6h1v4H9v11h2v-9h9V4h-2z",
);

export const SendIcon = makeIcon("M2.01 21 23 12 2.01 3 2 10l15 2-15 2z");
